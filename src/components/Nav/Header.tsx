...
const StyleName =
  'pl-5 text-slate-500 text-xs min-w-56 flex justify-start items-center h-full font-extrabold md:border-r border-0 border-slate-900'
const StyleContainer = 'relative w-full h-full flex justify-normal items-center'
const StyleLink =
   'md:w-28 w-0 h-full hover:text-slate-950 text-slate-500 hover:bg-slate-500 text-xs flex justify-center items-center md:border-r border-0 border-slate-900 overflow-hidden font-extrabold duration-300'
